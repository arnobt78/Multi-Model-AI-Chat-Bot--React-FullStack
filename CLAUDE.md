...
**Status:** C1 + thin stable Y-scrollbar gutter. Lint/build 0. Gate-0001 A+B approved. Firewall = Human-Action.
...
- UI: Lucide providers; delete confirm + AppToast bottom-right; Insights 3 tabs; thin Y scrollbar + `scrollbar-gutter: stable`; bubbles 85%; Thinking; send ripple
