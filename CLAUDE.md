...
**Status:** C1 + toast bottom-right + single-scroll shell. Lint/build 0. Gate-0001 A+B approved. Firewall = Human-Action.
...
- UI: Lucide providers; delete confirm + AppToast bottom-right; Insights 3 tabs + hourly tooltips; no page double/X scroll; bubbles 85%; Thinking; send ripple
